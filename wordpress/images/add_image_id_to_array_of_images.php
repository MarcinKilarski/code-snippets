...
function add_image_id_to_array_of_images() {
	...
	$image_arrays = [
		[
			'image-url' => 'https://example.com/wp-content/uploads/2020/05/image1.svg',
			'alt-text' => 'My alt text number 1',
		],
		[
			'image-url' => 'https://example.com/wp-content/uploads/2021/01/image2.jpg',
			'alt-text' => 'My alt text number 2',
		],
		[
			'image-url' => 'https://example.com/wp-content/uploads/2020/03/image3.png',
	...
	foreach ($image_arrays as $image_array) {
		...
		// if the image ID was found
		if ($get_image_id) {
			// add image it to the array item
			$image_array['id'] = $get_image_id;

			// add the image into a new array
